...
import com.bazaarvoice.ostrich.spi.Gauge;
import com.bazaarvoice.ostrich.spi.Meter;
 ...
 */
public class CoreZooKeeperHostDiscovery implements HostDiscovery {
    private static final Logger LOG = LoggerFactory.getLogger(CoreZooKeeperHostDiscovery.class);
    ...
    protected final Metrics _metrics;
    ...
    public CoreZooKeeperHostDiscovery(NodeDiscoveryFactory factory, CuratorFramework curator, String serviceName, Metrics metrics) {
        ...
        _metrics = metrics;
        _metrics.registerGauge(serviceName, "num-end-points", new Gauge<Integer>() {
            @Override
    ...
    public static class NodeDiscoveryFactory {
        public NodeDiscovery<ServiceEndPoint> create(CuratorFramework curator, String path,
