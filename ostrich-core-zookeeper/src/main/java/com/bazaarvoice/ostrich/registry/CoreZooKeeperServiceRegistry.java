 ...
 */
public class CoreZooKeeperServiceRegistry implements ServiceRegistry {
    /**
     ...
     */
    @VisibleForTesting
    public static final String ROOT_SERVICES_PATH = "/ostrich";
    ...
    public CoreZooKeeperServiceRegistry(NodeFactory nodeFactory, Metrics metrics) {
    ...
    @VisibleForTesting
    public void register(ServiceEndPoint endPoint, boolean includeRegistrationTime) {
        checkState(!_closed);
     ...
     * @return The ZooKeeper path.
     */
    public static String makeEndPointPath(ServiceEndPoint endPoint) {
    ...
    public static class NodeFactory {
        ...
        public NodeFactory(CuratorFramework curator) {
            _curator = checkNotNull(curator);
        }

        public PersistentEphemeralNode create(String path, byte[] data) {
