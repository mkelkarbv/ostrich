...
class CoreAsyncServicePool<S> implements com.bazaarvoice.ostrich.AsyncServicePool<S> {
    ...
    CoreAsyncServicePool(Ticker ticker, ServicePool<S> pool, boolean shutdownPoolOnClose,
                         ExecutorService executor, boolean shutdownExecutorOnClose, Metrics metrics) {
