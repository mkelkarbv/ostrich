...
public class InstanceMetricsTest {
    ...
    private Collection<Metrics.InstanceMetrics> _created = Lists.newArrayList();
    ...
    public void testNullServiceName() {
        Metrics.forInstance(INSTANCE_ONE, null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testEmptyServiceName() {
        Metrics.forInstance(INSTANCE_ONE, "");
    }
    ...
    private Metrics.InstanceMetrics newMetrics(Object instance, String serviceName) {
        Metrics.InstanceMetrics metrics = Metrics.forInstance(instance, serviceName);
