 ...
 */
public class ZooKeeperHostDiscovery extends CoreZooKeeperHostDiscovery {

    public ZooKeeperHostDiscovery(CuratorFramework curator, String serviceName, Metrics metrics) {
        this(new CoreZooKeeperHostDiscovery.NodeDiscoveryFactory(), curator, serviceName, metrics);
    }

    @VisibleForTesting ZooKeeperHostDiscovery(NodeDiscoveryFactory factory, CuratorFramework curator, String serviceName, Metrics metrics) {
